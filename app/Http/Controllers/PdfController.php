        ...
        $output = '<link rel="stylesheet" href="frontend/css/style1.css">
            <table class="table">
                <thead class="thead">
                    ...
                    <tr class="text-left">
                        <th>Client Name : '.$nom.'<br> Client Address : '.$adresse.' <br> Client Tel : '.$tele.' <br> Date : '.$date.'</th>
                        <th class="image-prod"><img src="log.png" alt="" style = "height: 80px; width: 80px;"></th>
                    </tr>
                </thead>
            </table>
            <table class="table">
                    ...
                    foreach($orders as $order){
                        ...
                        foreach($order->cart->items as $item){
                            ...
                            $output .= '<tr class="text-center">
                                        ...
                                        <td class="price"> '.$item['product_price'].' DH</td>
                                        <td class="qty">'.$item['qty'].'</td>
                                        <td class="total"> '.$item['product_price']*$item['qty'].' DH</td>
                                    </tr><!-- END TR-->
                                    </tbody>';
